...
(function(){
  ...
  const rememberLoginChk = document.getElementById('rememberLogin');
  ...
  document.addEventListener('DOMContentLoaded', () => {
    // Branding / login state handling
    // On startup, decide whether to show login or app view
    const tokenExists = localStorage.getItem('admin_token') || localStorage.getItem('user_token');
    const remember = (localStorage.getItem('admin_remember') === 'true') || (localStorage.getItem('user_remember') === 'true');
    if (tokenExists && remember) {
      showAppView();
    } else {
      showLoginView();
    }
